"""检查 AI Short Video 是否存在可用的新正式版本。"""
...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/dlazyai/ai-short-video/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/dlazyai/ai-short-video/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "ai-short-video-version-checker",
}
...
def get_available_update(current_version: str) -> str | None:
    ...
    logger.info(
        "AI Short Video update available: "
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a AI Short Video update"
            )
