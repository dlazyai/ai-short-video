...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/ai-short-video/config.toml'
...
def save_config():
    ...
    with _config_save_lock:
        ...
        config_to_save["dlazy"] = dict(dlazy)
...
# One section for every model call: script, voice-over, subtitles, footage, music.
dlazy = _SynchronizedConfig(_cfg.get("dlazy", {}))
...
project_name = _cfg.get("project_name", "AI Short Video")
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/dlazyai/ai-short-video'>https://github.com/dlazyai/ai-short-video</a>",
)
